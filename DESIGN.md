...
- **Review:** Open on critical moment I. Keep moments in chronological game order, labelled only I, II, III. The board before the move, red/green overlays, SAN recommendation, and one factual consequence form one focused lesson. While a post-game review is incomplete, show a direct saved-progress count and permit resuming later. Never imply a browser Worker continues after the tab closes.
