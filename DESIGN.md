...
- **Learn:** Introduce opening families and named variations through a board-first explorer. The selected opening or variation is the page’s current learning object. Use the gold study marker only for the selected learning context. Show standard notation, a concise factual learning note, and quiet repertoire saving. Do not show engine evaluation, mastery scores, streaks, or a drill interface before real repertoire content exists.
